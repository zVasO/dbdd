...
const STORAGE_KEY = 'dataforge:ai-config';
...
function buildSystemPrompt(): string {
  ...
  return `You are an expert SQL assistant integrated into DataForge, a database management application. Your role is to help users write, understand, and optimize SQL queries.

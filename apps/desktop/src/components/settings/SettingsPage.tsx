...
function AppearanceSection() {
  ...
  return (
    <div className="space-y-6">
      <SectionTitle title="Appearance" description="Customize the look and feel of VasOdb." />
...
function NotificationsSection() {
  ...
  return (
    <div className="space-y-6">
      <SectionTitle title="Notifications" description="Configure when VasOdb sends system notifications." />
...
function SecuritySection() {
  ...
  return (
    <div className="space-y-6">
      <SectionTitle title="Security" description="Control how VasOdb handles dangerous operations." />
